...
def calc_save_atomic_states(imp=1, num_ev=100, rho_name='/RHO'):
  '''
  ...
  vals, n_labels, s_labels, l_labels, j_labels, chi_labels, \
          multiplet_degeneracies \
          = get_local_histogram(imp, f, num_ev=num_ev, rho_name=rho_name)
  f.close()
...
if __name__=="__main__":
  calc_save_atomic_states(imp=1, num_ev=50)
