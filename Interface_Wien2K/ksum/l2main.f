SUBROUTINE L2MAIN(Qcomplex,nsymop,Qident,mode,projector,Qrenormalize,fUdmft)
  ...
  USE com,     ONLY: MINWAV, MAXWAV, iso, iso2, emin, emax, EF, WEIGH, elecn,BND_NE,EFMOD,DELTA
  ...
  integer     :: iorb, L, nind, ip, iq, it, ioccur, ic, ikp, iikp, ivector, iks,nkp,N, NE, NEMIN, NEMAX, nbands, isym, M, IND_YL, ibb, LATOM
