...
!
RECURSIVE subroutine fdjac1 ( fcn, n, x, fvec, fjac, ldfjac, iflag, ml, mu, epsfcn )
!
!*****************************************************************************80
!
...
!
RECURSIVE subroutine hybrd ( fcn, n, x, fvec, xtol, maxfev, ml, mu, epsfcn, diag, mode, &
...
!
     iflag = 2
! YYX begin
     INQUIRE(FILE='GLP_FJAC.INP',EXIST=LFJAC)
     IF(NFJAC==0.AND.LFJAC)THEN
       OPEN(IU,FILE='GLP_FJAC.INP',STATUS='OLD')
       READ(IU,*)fjac
       CLOSE(IU)
     ELSE  
       ...
       NFJAC=NFJAC+1
       IF(iflag>=0)THEN
       OPEN(IU,FILE='GLP_FJAC.OUT',STATUS='REPLACE')
       WRITE(IU,'(10E24.16)')FJAC
       CLOSE(IU)
       ENDIF
     ENDIF
     nfev = nfev + msum
...
! YYX begih
  WRITE(IO,'(" NFJAC=",I4)')NFJAC
! YYX end
!
  return
end
!
RECURSIVE subroutine hybrd1 ( fcn, n, x, fvec, tol, epsfcn, info )
!
!*****************************************************************************80
!
