      SUBROUTINE YLM(V,LMAX)
      INTEGER            LMAX
      DOUBLE PRECISION   V(3)
      COMPLEX*16         Y((LMAX+1)**2)
!     ..................................................................
! 1.     PROGRAM UNIT 'YLM'
...
!
      open(7,file='w_ylm.txt',status='replace')
...
!
    ...
    write(7,'("SINTH,COSTH,SINPH,COSPH:")')
    write(7,'(4f12.7)')SINTH,COSTH,SINPH,COSPH
...
!
   ...
   do l=0,lmax; do m=-l,l
    lm=lm+1
    write(7,'(i2,i3,2f16.10)')l,m,Y(lm)
   enddo; enddo
   close(7)
!
  999 RETURN
